...
const sampleData: ClientKwitansiItem[] = [];
...
export default function ClientManagement() {
    ...
    const [data, setData] = useState<ClientKwitansiItem[]>(sampleData);
    const [sortConfig, setSortConfig] = useState<{
        key: keyof ClientKwitansiItem;
        direction: 'asc' | 'desc';
    } | null>(null);
    ...
    const [formData, setFormData] = useState<Omit<ClientKwitansiItem, 'id'>>({
        clientId: '',
        phone: '',
        email: '',
        name: '',
    ...
    const handleSort = (key: keyof ClientKwitansiItem) => {
    ...
    const renderSortIcon = (key: keyof ClientKwitansiItem) => {
    ...
    const handleAdd = () => {
        if (validateForm()) {
            const newItem: ClientKwitansiItem = {
    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4">
                <h1 className="text-2xl font-bold">Data Kwitansi / Client</h1>
