...
export default function ClientManagement() {
    ...
    const [data, setData] = useState<ClientSMItem[]>(sampleData);
    const [sortConfig, setSortConfig] = useState<{
        key: keyof ClientSMItem;
        direction: 'asc' | 'desc';
    } | null>(null);
    ...
    const [formData, setFormData] = useState<Omit<ClientSMItem, 'id'>>({
        clientId: '',
        phone: '',
        email: '',
        name: '',
    ...
    const handleSort = (key: keyof ClientSMItem) => {
    ...
    const renderSortIcon = (key: keyof ClientSMItem) => {
    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4">
                <h1 className="text-2xl font-bold">Data Surat Masuk / Client</h1>
                                                ...
                                                <td className="relative px-4 py-3 whitespace-nowrap">
                                                    ...
                                                    {showMenu === item.id && (
                                                        <div className="absolute right-4 z-10 mt-1 w-32 rounded border bg-white shadow-md">
                                                            <button
                                                                onClick={() => {
                                                                    router.visit(`/persuratan/surat-masuk/`);
                                                                    setShowMenu(null);
                                                                }}
